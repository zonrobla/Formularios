...
public class ServletCapturaVehiculo extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response) 
        ...
        String marca = request.getParameter(MARCA);//Pasar a coNIVELnstantes. No debe haber código quemado.(hardcoded)
    ...
    private void almacenarVehiculo(HttpServletResponse response, String idVehiculo, 
        ...
        if (!"".equalsIgnoreCase(idVehiculo) && !"".equalsIgnoreCase(modelo) && !"".equalsIgnoreCase(marca) && 
            !"".equalsIgnoreCase(puertas) && !"".equalsIgnoreCase(placa) && !"".equalsIgnoreCase(color)) {//Ajustar para que el string que es conocido vaya de primeras, esto evita NullPointerExceptions
            ...
            if (insercionVehiculoCorrecta) {
                ...
                try {
                    ...
                    st = con.prepareStatement("SELECT * FROM VEHICULO");
