...
public class ServletCapturaPersona extends HttpServlet {
    ...
    private void almacenarPersona(HttpServletResponse response, String fec, 
                                  String idPersona, String nom, String res, 
                                  String ape, String niv, String idVehiculo ) throws IOException {
        ...
        if (validarEntradasPersona(idPersona, nom, ape, niv, res, fec, idVehiculo)) {
            ...
            if (insercionPersonaCorrecta) {
                ...
                try (Connection con = c.getConexion();
                    PreparedStatement st = con.prepareStatement("SELECT * FROM PERSONA");
    ...
    private boolean validarEntradasPersona(String idPersona, String nom, String ape, 
                                           String niv, String res, String fec, 
                                           String idVehiculo) {
        
        return ("".equalsIgnoreCase(idPersona) || "".equalsIgnoreCase(nom) || "".equalsIgnoreCase(ape) || 
                "".equalsIgnoreCase(niv) || "".equalsIgnoreCase(res) || "".equalsIgnoreCase(fec) || 
                "".equalsIgnoreCase(idVehiculo));
    }
}